       ...
       <div id="content">
            ...
            <?php
                 ...
                 if(strlen($product_info['products_uses']))
                 {
                   ...
                   {
                    $item=trim($item);
                    $mflink=link_exists('/natural_uses.php?use='.urlencode(strtolower($item)),$page_links) ;
                    $mflink=strlen($mflink) ? $mflink : '/natural_uses.php?use='.urlencode(strtolower($item));
