...
if (isset($HTTP_POST_VARS['action']) && ($HTTP_POST_VARS['action'] == 'process')) {
	...
	if ($error == false) {
		...
		if ($createaccount == 'Y')
	{if($create_password ==1){$email_text .=PASSWORD_CREATED.': '.$password;}
...
?>
<td width="100%" valign="top"><?php echo tep_draw_form('create_account', tep_href_link('create_account1.php', '', 'SSL'), 'post', 'onSubmit="return check_form(create_account);"') . tep_draw_hidden_field('action', 'process'). tep_draw_hidden_field('fromlogin', $fromlogin); ?>
<tr>
