                        ...
                        <table border="0" width="100%" cellspacing="1" cellpadding="2">
                            <tr>
                                ...
                                <td>
                                    ...
                                    { ?>
                                        <p>
                                            <?php echo $product_info['products_name'];?> is not available from Seacoast
                                            Vitamins at this time. We recommend the following alternatives, below.
                                        </p>
                                        <?php }
                                    else
                                    { ?>
                                                ...
                                                <form method="post" action="/shopping_cart.php">
                                                    ...
                                                    <input type="hidden" name="products_id"
                                                           value="<?php echo $_REQUEST['products_id']; ?>">
                                                    <b>Quantity:</b>
                                                    <select name="qty">
                                    ...
                                    { ?>
                                        <span
                                            style="font-size:8pt;color:#FF0000;font-weight:bold;">Hurry! Only <?php echo $product_info['products_dieqty']?>
                                        ...
                                        <?php } ?>
                                                    ...
                                                    <br/>
                                                    <div
                                                        style="margin-left:1em;float:left;border:dashed 1px #dddddd;padding-left:1em;padding-right:1em;">
                                                        <div>
                                                            <b>Choose Price</b>
                                                            <br/>
                                                            <input type="submit" class="btn btn-primary"
                                                                   id="button_price"
                                                                   value="<?php echo $currencies->display_price($cm_price, tep_get_tax_rate($product_info['products_tax_class_id'])); ?>*"
                                                                   style="width:200px;height:30px;color:#fff;font-weight:bold;font-size:18pt;">
                                                        </div>
                                                    ...
                                                    { ?>
                                                        ...
                                                        <input type="checkbox" name="cm_freetrial" value="true" checked
                                                               onclick="toggle_price(this.checked);"/> Yes! I want
                                                        Direct-to-Member prices.<br/>My membership is FREE for 14-days.
                                                        <span id="extra_savings" style="display:none;"><br/><span
                                                            style="color:#ff0000;font-weight:bold;">Save an extra <?php echo number_format(($price - $cm_price) / $price * 100, 0) ?>
                                                            % plus
                                                        </span></span>
                                                        <br/>I'll get:
                                                        <ul style="font-weight:bold;margin-left:3em;">
                                                            <li>Member prices, cheap shipping</li>
                                                            <li>Side Effects Protection; <br/><i
                                                                style="font-weight:normal;">Return opened product</i>
                                                            </li>
                                                        </ul>
                                                        <?php } ?>
                                                        <div id="cm_price_disclaimer"><i>* Seacoast Vitamins-Direct
                                                            price shown.</i><br/>
                                                            <?php if(!$_SESSION['cm_is_member'])
                                                            { ?><a href="/community/" target="_blank" rel="nofollow">Learn
                                                                more.</a><?php } ?>
                                                        </div>
                                                        <?php } ?>
                                                    </div>
                                ...
                                <td>
                                    <div style="border:1px solid #665;padding:1em;margin:0px;text-align:center;">
                                        ...
                                        <div style="white-space:nowrap;"><img src="/images/quality.jpg"
                                                                              style="width:75px;"/><b
                                            style="color:#666666">
                                            <br/>
                                        ...
                                        <img src="http://www.shopping.com/merchant_logo?ID=406477" width="130"
                                             border="0" alt="Great Store!"/>
                                        <br/>
                                        <!-- BEGIN: BizRate Medal (125x73 pixels) -->
                                        <img style="margin-top:3em;"
                                             src="http://medals.bizrate.com/medals/dynamic/162489_medal.gif"
                ...
                <td colspan="5">
                    ...
                    for($i = 0, $n = sizeof($products); $i < $n; $i++)
                    {
                        ...
                        $info_box_contents[$cur_row][] = array(
                            'align'  => 'right',
                            'params' => 'class="productListing-data" valign="top"',
                            'text'   => $products[$i]['id'] == CM_FTPID ? '&nbsp;' : '<b><s>' . $currencies->display_price(($products[$i]['products_price'] > $products[$i]['msrp']) ? $products[$i]['products_price'] : $products[$i]['msrp'], tep_get_tax_rate($products[$i]['tax_class_id']), $products[$i]['quantity']) . '</s></b>'
                        );
                        $info_box_contents[$cur_row][] = array(
                            'align'  => 'right',
                            'params' => 'class="productListing-data" valign="top"',
                        ...
                        $info_box_contents[$cur_row][] = array(
                            'align'  => 'right',
                            'params' => 'class="productListing-data" valign="top"',
                            'text'   => $products[$i]['id'] == CM_FTPID ? '&nbsp;' : '<b>' . $currencies->display_price(//$products[$i]['savings'],
                                (($products[$i]['products_price'] > $products[$i]['msrp']) ? $products[$i]['products_price'] : $products[$i]['msrp']) - $products[$i]['final_price'], tep_get_tax_rate($products[$i]['tax_class_id']), $products[$i]['quantity']) . '</b>'
                        );
                        /*
    ...
    <div class="span12">
        ...
        <div style="padding:1em 0 1em 0;">
            ...
            <div class="spiffyfg" style="color:#ff0000;padding:20px;text-align: left;">
                ...
                <b>Direct-to-member prices:</b> You are now using a FREE 14-Day Seacoast Vitamins-Direct trial
                membership.
                ...
                <a style="color:#ff0000;font-weight:bold;"
                   href="/shopping_cart.php?action=buy_now&products_id=<?php echo CM_FTPID ?>">Start Now</a> or <a
                    href="/community/" style="color:#ff0000">Learn more...</a>
                <?php endif;?>
            </div>
        </div>
        <?php endif;?>
...
<div class="row" style="padding-top:20px;padding-bottom:40px;">
    <div class="span6">
        <a style="float:left;" class="btn btn-primary" title="Checkout Now"
           href="<?php echo tep_href_link(FILENAME_CHECKOUT_SHIPPING, '', 'SSL');?>">
            <i class="icon-play icon-white">&nbsp;</i>&nbsp;Checkout Now
        </a>
        <?php if(!$hasAddress && tep_session_is_registered('customer_id')): ?>
        <a style="float:left; margin-left:10px;" class="btn btn-primary" title="Add adress"
           href="<?php echo tep_href_link('address_book_process.php', '', 'SSL');?>">
            Add address
        </a>
        <?php endif;?>
    </div>
    <div class="span6">
        ...
        <b>Member Savings: <span
            style="color:#ff0000;background:yellow;">$<?php echo number_format($totalSavings, 2);?></span></b><br/>
        <?php endif;?>
...
<noscript>
    <img height="1" width="1" border="0"
         src="https://www.googleadservices.com/pagead/conversion/1064963330/?value=0.0&amp;label=AC7MCM6IYRCCmuj7Aw&amp;script=0"/>
</noscript>
<script>
    if(typeof (urchinTracker) != 'function')
        document.write('<sc' + 'ript src="' + 'http' + (document.location.protocol == 'https:' ? 's://ssl' : '://www') + '.google-analytics.com/urchin.js' + '"></sc' + 'ript>')
