...
*/
  ...
  if (isset($HTTP_GET_VARS['action']) && ($HTTP_GET_VARS['action'] == 'get')) {
   $rss_title = (isset($HTTP_POST_VARS['rss_title']) ? $HTTP_POST_VARS['rss_title'] : '');
	 $rss_desc = (isset($HTTP_POST_VARS['rss_desc']) ? $HTTP_POST_VARS['rss_desc'] : '');
	 $rss_link = (isset($HTTP_POST_VARS['rss_link']) ? $HTTP_POST_VARS['rss_link'] : '');
   $rss_item_title = (isset($HTTP_POST_VARS['rss_item_title']) ? $HTTP_POST_VARS['rss_item_title'] : '');
	 $rss_item_desc = (isset($HTTP_POST_VARS['rss_item_desc']) ? $HTTP_POST_VARS['rss_item_desc'] : '');
	 $rss_item_link = (isset($HTTP_POST_VARS['rss_item_link']) ? $HTTP_POST_VARS['rss_item_link'] : '');
   $error = false;
         ...
         <td><table border="0" cellspacing="2" cellpadding="2">
          <tr> 
           ...
           <td><?php echo tep_draw_input_field('rss_title', tep_not_null($rss_title) ? $rss_title : '', 'maxlength="255", size="40"',   false); ?> </td>
					...
					<tr> 
			  	 <td>Description: </td>
           <td><?php echo tep_draw_input_field('rss_desc', tep_not_null($rss_desc) ? $rss_desc : '', 'maxlength="255", size="40"',   false); ?> </td>
    	   	</tr>
					<tr> 
			  	 <td>Link: </td>
           ...
           <td><?php echo tep_draw_input_field('rss_item_desc', tep_not_null($rss_item_desc) ? $rss_item_desc : '', 'maxlength="255", size="40"',   false); ?> </td>
    	   	</tr>
					<tr> 
			  	 <td>Item Link: </td>
