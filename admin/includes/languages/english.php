...
define('BOX_TOOLS_CLEAN_CC', 'Clean CC numbers');
...
define('BOX_TEMPLATES_INFOBOX', 'Infobox Skins');



define('BOX_TEMPLATES_INFOBOX_MAPPING', 'Infobox Skin Mapping');
...
define('BOX_NEWSLETTERS', 'Newsletter Categories');
define('BOX_NEWSLETTER_ITEMS', 'Newsletter Items');
...
define('TEXT_PRODUCT_UPC', 'This is the UPC');
...
define('IMAGE_REMOVECVV' , 'Remove CVV'); // cvv contribution
...
require(DIR_WS_LANGUAGES . 'add_ccgvdc_english.php'); //ICW CREDIT CLASS GIFT VOUCHER ADDITION
...
define('BOX_QUICK_PRICEUPDATES', 'Quick Price Updates');



define('BOX_REPORTS_CUSTOMERS_PER_PRODUCT', 'Customers/Products');
