...
define('TABLE_HEADING_SORTIERUNG', 'Assortment');
define('TABLE_HEADING_EINHEIT', 'Contents/<br>Unit');
define('TABLE_HEADING_PRICE', 'Price');
define('TABLE_HEADING_PRICE_EK', 'Purchase price');
define('TABLE_HEADING_ANGEBOT', 'Offer<br>no/yes');
define('TABLE_HEADING_BASE_PRICE', 'Base<br>price factor');
define('TABLE_HEADING_BASE_UNIT', 'Fundamental value');
