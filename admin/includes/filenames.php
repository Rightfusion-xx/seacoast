...
// define the filenames used in the project
  ...
  define('FILENAME_STATS_CUSTOMERS_PER_PRODUCT', 'stats_customers_per_product.php');
...
// added for multi product select
 ...
 // added for order tracking module
...
define('FILENAME_QUICK_PRICEUPDATES', 'quick_priceupdates.php');
