...
<tr>
<td class="main">
<?php echo TEXT_PRODUCTS_CARROT; ?>
</td>
<td class="main">
<?php echo tep_draw_separator('pixel_trans.gif', '24', '15') . '&nbsp;' . tep_draw_checkbox_field('products_carrot', '', $pInfo->products_carrot); ?>
</td>
</tr>
<tr>
<td class="main">
<?php echo 'Kill Product:'; ?>
</td>
<td class="main">
<?php echo tep_draw_separator('pixel_trans.gif', '24', '15') . '&nbsp;' . tep_draw_checkbox_field('products_die', '', $pInfo->products_die); ?>
</td>
</tr>
<tr>
<td class="main">
<?php echo 'Orders \'til Dead:'; ?>
</td>
<td class="main">
<?php echo tep_draw_separator('pixel_trans.gif', '24', '15') . '&nbsp;' . tep_draw_input_field('products_dieqty', $pInfo->products_dieqty); ?>
</td>
</tr>
<tr>
<td colspan="2">
...
<td class="main">
<?php echo tep_draw_separator('pixel_trans.gif', '24', '15') . '&nbsp;' . tep_draw_input_field('products_upc', $pInfo->products_upc); ?>
</td>
</tr>
...
<td class="main">
<?php echo tep_draw_separator('pixel_trans.gif', '24', '15') . '&nbsp;' . tep_draw_input_field('products_sku', $pInfo->products_sku); ?>
</td>
</tr>
...
<tr bgcolor="#ebebff">
<td class="main">
<?php echo TEXT_PRODUCTS_PRICE_MSRP; ?>
</td>
<td class="main">
<?php echo tep_draw_separator('pixel_trans.gif', '24', '15') . '&nbsp;' . tep_draw_input_field('products_msrp', $pInfo->products_msrp); ?>
</td>
</tr>
<tr bgcolor="#ebebff">
<td class="main">
...
<tr>      <tr>
            ...
            <td class="main" valign="top"><?php  echo 'Product Types (e.g. 5-HTP, Vitamin B, Omega-3):'; ?>
...
?>
           <tr>
            <td class="main" valign="top"><?php  echo 'Ailments:'; ?>
          ...
          <tr>
           ...
           <tr>
            <td class="main" valign="top"><?php  echo 'Uses:'; ?>
          ...
          <tr>
           ...
           <tr>
            <td class="main" valign="top"><?php  echo 'Departments:'; ?>
          ...
          <tr>
            <td colspan="2"><?php echo tep_draw_separator('pixel_trans.gif', '1', '10'); ?></td>
          </tr>            <td colspan="2" class="main"><hr></td>
          </tr>
<!-- HTC EOC //-->
<tr>
<td class="main">
...
<tr>
<td class="main">
<?php echo 'Qty Available'; ?>
</td>
<td class="main">
<?php echo tep_draw_separator('pixel_trans.gif', '24', '15') . '&nbsp;' . tep_draw_input_field('products_available', $pInfo->products_available); ?>
</td>
</tr>
<tr>
<td class="main">
...
<td class="main">  
<?php echo tep_draw_separator('pixel_trans.gif', '24', '15') . '&nbsp;' . tep_draw_input_field('products_location', $location_log['location']); ?>
</td>
</tr>
<tr>
<td colspan="2">
...
<td class="main">
<?php echo tep_draw_separator('pixel_trans.gif', '24', '15') . '&nbsp;' . tep_draw_file_field('products_image') . '<br>' . tep_draw_separator('pixel_trans.gif', '24', '15') . '&nbsp;' . $pInfo->products_image . tep_draw_hidden_field('products_previous_image', $pInfo->products_image); ?>
</td>
</tr>
<tr>
<td colspan="2">
...
<td class="main">
<?php echo tep_image(DIR_WS_CATALOG_LANGUAGES . $languages[$i]['directory'] . '/images/' . $languages[$i]['image'], $languages[$i]['name']) . '&nbsp;' . tep_draw_input_field('products_url[' . $languages[$i]['id'] . ']', (isset($products_url[$languages[$i]['id']]) ? $products_url[$languages[$i]['id']] : tep_get_products_url($pInfo->products_id, $languages[$i]['id']))); ?>
</td>
</tr>
<?php
}
