...
if($free_shipping==true && !$shipping==true)
{
    $shipping='free_free';
}
...
if( $free_shipping !=true &&
    (
        ...
        (tep_session_is_registered('shipping') && ($shipping == false) && (tep_count_shipping_modules() > 1))
    )
)
{
...
<!-- body //-->
                    ...
                    <table border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                            <td  valign="top" style="line-height:175%; ">
                                ...
                                <div style="padding-bottom:20px;padding-right:100px;float:left;">
                                    <?php echo '<b>' . 'Shipping To:' . '</b> <a href="' . tep_href_link(FILENAME_CHECKOUT_SHIPPING_ADDRESS, '', 'SSL') . '"><span class="orderEdit">(' . 'Change Address' . ')</span></a>'; ?>
                                    <br/>
                                    <?php echo tep_address_format($order->delivery['format_id'], $order->delivery, 1, ' ', '<br>');?>
                                </div>
                                <div style="padding-bottom:20px;float:left;clear:right;">
                                    <?php echo '<b>' . 'Bill To:' . '</b> <a href="' . tep_href_link(FILENAME_CHECKOUT_PAYMENT_ADDRESS, '', 'SSL') . '"><span class="orderEdit">(' . 'Change Address' . ')</span></a>'; ?>
                                    <br/>
                                            ...
                                            <table border="0" cellspacing="0" cellpadding="2">
                                                <tr>
                                                    ...
                                                    <td class="main" align="right">
                                                        ...
                                                        <?php if($cart->in_cart(CM_FTPID) || $cart->in_cart(CM_PID)):?>
                                                            <br/>
                                                            By clicking continue, you accept & understand <br/>the Seacoast Vitamins-Direct FREE Trial
                                                            <br/>
    ...
    <noscript><img height="1" width="1" border="0" src="https://www.googleadservices.com/pagead/conversion/1064963330/?value=0.0&amp;label=Bx18CKiJYRCCmuj7Aw&amp;script=0"/></noscript>
</body>
</html>
