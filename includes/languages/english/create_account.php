...
define('TEXT_ORIGIN_LOGIN', '<font color="#FF0000"><small><b>NOTE:</b></font></small> If you already have an account with us, please login at the <a href="login.php"><img src="includes/languages/english/images/buttons/button_login.gif" border="0"></a>' .
'<br>If you are from a country other than the USA, please select your country from the drop down menu first, as the page will refresh when a new country is chosen.');
...
define('EMAIL_GV_INCENTIVE_HEADER', "\n\n" .'As part of our welcome to new customers, we have sent you an e-Gift Certificate worth %s');
define('EMAIL_GV_REDEEM', 'The redeem code for the e-Gift Certificate is %s, you can enter the redeem code when checking out while making a purchase');
