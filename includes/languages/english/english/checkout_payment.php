...
define('TABLE_HEADING_COMMENTS', 'Enter coupon code or comments here:<BR><I>Note: coupon discounts are not reflected on your invoice but will be manually applied when we process your order. Some items (marked with an *) are exempt.');
