...
define('HEADING_TITLE', 'Shopping Cart Contents<br><span class="style1">an * after the product name indicates price excludes all other promotions<br>(* = coupon not usable with this product)</span>');
