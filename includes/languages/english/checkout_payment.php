...
define('TABLE_HEADING_COMMENTS', '<font color="#FF0000"><b>Do you have a coupon? </b></font> If so please enter your coupon code below:<BR><I>Note: coupon discounts are not reflected on your invoice but will be manually applied when we process your order. Some items (marked with an *) are exempt.');
