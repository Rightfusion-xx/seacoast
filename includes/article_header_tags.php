...
// ARTICLES.PHP
    case ((strstr($HTTP_SERVER_VARS['PHP_SELF'],'articles.php') or strstr($PHP_SELF,'articles.php')) &! strstr($PHP_SELF,'new_articles.php')):
...
// ARTICLE_INFO.PHP
  case ( strstr($HTTP_SERVER_VARS['PHP_SELF'],'article_info.php') or strstr($PHP_SELF,'article_info.php') ):
...
// ARTICLES_NEW.PHP
  case ( strstr($HTTP_SERVER_VARS['PHP_SELF'],'articles_new.php') or strstr($PHP_SELF,'articles_new.php') ):
...
// ARTICLES_REVIEWS_INFO.PHP and ARTICLES_REVIEWS.PHP
  case ( strstr($HTTP_SERVER_VARS['PHP_SELF'],'article_reviews_info.php') or strstr($HTTP_SERVER_VARS['PHP_SELF'],'article_reviews.php') or strstr($PHP_SELF,'article_reviews_info.php') or strstr($PHP_SELF,'article_reviews.php') ):
