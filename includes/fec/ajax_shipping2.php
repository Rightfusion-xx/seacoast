...
<noscript><tr align="right"  class="infoBoxContents" > <td class="main" align="right"></td><td></td><td align="right">
                <INPUT TYPE="GET" class="button" name="save" value="update total">
                <?php// echo tep_image_submit('button_update_total.gif', IMAGE_BUTTON_CONTINUE,'name="save" value="update total"onmouseover="loadXMLDoc(this.value);"');  ?></td></tr></noscript>

<tr> <td class="main" align="right"></td><td></td><td align="right"><script type="text/javascript">

<!--//

document.write('<input type=button class="button" value=" Get New Total" onclick="ajaxLoader(\'checkout_2confirmation.php?tip=\'+ zprice+\'&cb=\'+submitter+\'&zship=\'+zhipper+\'&osCsid=\'+Csid,\'contentLYR\')" name="CLEARBUTTON">');
