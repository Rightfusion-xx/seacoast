<div style="float:right;width:300;margin-left:20px;" id="hn_topics">
    ...
    <div id="nav_manufacturers" class="nav_box" style="margin-top:20px;margin-bottom:50px;">
  <div class="nav_header">
    Healthy Water
  </div>
  <div style="text-align:center;padding:10px;">
    <A href="http://www.aquasanaaffiliates.com/b.asp?id=3711" rel="nofollow" target="_blank" style="background-color:#ffffff;">
      <img src="http://www.aquasanaaffiliates.com/showban.asp?id=3711&img=banner4.jpg" border="0">
        </a>
      </div></div>
...
<h1>Seacoast Vitamins - A Natural Choice</h1>
<p>

  Seacoast Vitamins champions lifelong health and vitality.  Our friendly, knowledgeable staff assists each customer by providing natural health information and product recommendations.  Everyday low prices on vitamins, minerals, herbs, and other natural healing products allow you to immediately experience the benefits of a healthy lifestyle.  Twenty-five years of experience and the highest quality vitamin supplements, service, and knowledge make Seacoast Vitamins your natural choice.
...
<p>
  <?php
    $products_die_q=tep_db_query('select products_name, p.products_image, p.products_id, specials_new_products_price, products_msrp, manufacturers_name, cast(((products_msrp-products_price)/products_msrp*100.00) as signed) as discountpct from
        ...
        where products_die=1 and products_dieqty>0 
    ...
    while($products_die=tep_db_fetch_array($products_die_q))
    {
      ...
      <div id="prod2" class="mini-product_regular">
        <div style="float:left;" class="mini-listing-image">
          <a href="/products_info.php?products_id=<?php echo $products_die['products_id']?>"><img src="<?php echo $products_die['products_image'];?>" border="0" width="50" style="margin:5px;" ALIGN="left" /></a>
        </div>&nbsp;<a href="/products_info.php?products_id=<?php echo $products_die['products_id']?>">
          <b><?php echo $products_die['products_name'];?></b>
        </a><br/><span style="color:#66CC00;font-weight:bold;">&nbsp;<?php echo $products_die['specials_new_products_price']?>&nbsp;</span> from <b><?php echo $products_die['manufacturers_name']?></b><br/><span style="color:#ff0000;font-weight:bold;"><?php echo $products_die['discountpct']?>% Off</span><br>
          <br>
            <br style="clear:both;"/>
      </div>
      <?php 
...
<h2>Movers & Shakers - Fastest Selling Supplements (3 Days)</h2>
...
<?php
  ...
  $departmentCategories[]='';
    ...
    $select_column_list = '';
          ...
          $select_column_list .= 'm.manufacturers_name, products_image, pd.products_ailments, pd.products_uses, pd.products_departments, ';
