<?php
  ...
  if (STORE_SESSIONS == 'mysql') {
    ...
    function _sess_write($key, $val) {
      ...
      if((is_object($cart) && $cart->count_contents()>0) || $cart->been_used) //only save session if something is in cart.
      {
  ...
  function refresh_user_info()
  {
  		...
  		unset($_SESSION['user_info_updated']);
  	  	unset($_SESSION['cm_expiration']);
  	  	unset($_SESSION['cm_renew']);
  	  	unset($_SESSION['cm_savings']);
  	  	unset($_SESSION['cm_member_since']);
