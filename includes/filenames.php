...
// define the filenames used in the project
  ...
  define('FILENAME_YOURFRONTPAGE', 'yourfrontpage.php'); //  yourfrontpage Module
...
// VJ Links Manager v1.00 end
  ...
  define('FILENAME_PRODUCT_SPECIALS', 'product_specials.php');
  // EOF: Product Specials Module v1.0
