...
// class constructor
    function usps() {
      ...
      $this->types = array('Priority' => 'Standard Delivery (2-3 days transit with tracking)',
                            'Express' => 'Express Delivery (1-2 days transit guaranteed - Order By 12pm EST)'
                            //'First Class' => 'First-Class Mail (2-9 days)'
                            );
...
// usps doesnt accept zero weight
      ...
      if ($order->delivery['country']['id'] == SHIPPING_ORIGIN_COUNTRY) {
        ...
        while (list($key, $value) = each($this->types)) {
          $request .= '<Package ID="' . $services_count . '">' .
                      ...
                      '<Container>' . ($key=='Priority' && $this->pounds>1 ? 'flat rate box' : $this->container) . '</Container>' .
                      '<Size>' . $this->size . '</Size>' .
    ...
    $ServiceMap=array('0'=>'First Class',
                        '1'=>'Priority',
                        '2'=>'Express',
                        '3'=>'Express',
                        '4'=>'Parcel',
