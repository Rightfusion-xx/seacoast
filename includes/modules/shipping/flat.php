...
// class constructor
    function flat() {
      ...
      if($order->delivery['country_id']==223 && (strtoupper($state)!='HI' && strtoupper($state)!='AK' && strtoupper($state)!='PR' && $order->info['total'] < MODULE_ORDER_TOTAL_SHIPPING_FREE_SHIPPING_OVER))
      {
