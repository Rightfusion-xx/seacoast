...
$url_patterns=array(
    ...
    $replacement="\"/ailments/".seo_url_title($replacement, $page)."\"";',
    ...
    $replacement="\"/uses/".seo_url_title($replacement, $page)."\"";' ,
    ...
    $products_name=tep_db_fetch_array(tep_db_query("select products_name from products_description where products_id=".(int)$replacement));                                                                        
    $replacement="\"/p/".seo_url_title($products_name["products_name"]."-".$replacement, $page)."\"";',
    ...
    $replacement="\"/m/".seo_url_title($manufacturers_name["manufacturers_name"]."-".$replacement, $page)."\"";', 
    ...
    $replacement="\"/c/".seo_url_title($categories_name["categories_name"]."-".$replacement, $page)."\"";' 
