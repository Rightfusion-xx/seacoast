...
// end cvv contribution
    ...
    function pre_confirmation_check() {
      global $HTTP_POST_VARS, $cc_card_type, $cc_card_expiration, $cc_card_number;
...
// end cvv contribution
      ...
      $this->cc_card_expiration = $HTTP_POST_VARS['cc_expires_month'] . $HTTP_POST_VARS['cc_expires_year'];
      $cc_card_type=$this->cc_card_type;
      $cc_card_number=$this->cc_card_number;
      $cc_card_expiration=$this->cc_card_expiration;
      $cc_card_owner=$HTTP_POST_VARS['cc_owner'];
      /*tep_session_register('cc_card_type');
      tep_session_register('cc_card_number');
      tep_session_register('cc_card_expiration');
