...
<div id="nav_manufacturers" class="nav_box">
  ...
  <div class="nav_header">Additional Resources</div>    
  <?php
...
echo '<a href="/health_library.php">Health Library</a><br>'.
'<a href="/details.php">Site Details</a><br><br>'.
...
'<br><br><img src="images/ReliabilitySeal2.gif" border="0" style="padding-left:10px;">';
?>
