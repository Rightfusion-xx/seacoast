...
<?php
  ...
  $info_box_contents[] = array('text' => 'Nutritional Information');
...
?>
  ...
  $info_box_contents = array();
  $info_box_contents[] = array('text' => '<b><a href="index.php">Home Page</a></b><hr width="100%" size="1">' .
                                         '<b>Informative Sites</b><hr width="100%" size="1">' .
                                         '<b>Articles & Information</b><hr width="100%" size="1">' .
