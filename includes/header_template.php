...
<div class="content-width block-center" style="margin-bottom:10px;">
    <div class="header">
    ...
    <div class="content">
        <h2><?php echo(!empty($_REQUEST['page_caption']) ? $_REQUEST['page_caption'] :'Vitamins - Direct To Members from Seacoast Vitamins')?></h2>
    </div>
</div>
<?php /*
<div id="header">
