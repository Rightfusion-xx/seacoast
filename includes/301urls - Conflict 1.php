<?php
    define('NO_HTTPS',',fake.php,product_info.php,index-hidden.php,index.php,product_reviews.php,topic.php,health_library.php,ailments.php,natural_uses.php,departments.php,404-1.php,cheapest,zyflamend,symptoms,ailments-diseases,health-guides');
