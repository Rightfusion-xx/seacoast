...
<tr>
<td><?php  if ($show_login ==1) { require('includes/fec/login_box2.php');}
...
<?php if ($messageStack->size('create_account') > 0) {?>
	<tr><td><?php echo $messageStack->output('create_account'); ?></td><td>&nbsp;</td></tr>
<?php } ?>
<tr>
...
<tr>
<td class="main"><?php echo tep_draw_form('checkout', tep_href_link('create_account2.php', '', 'SSL'), 'post','onSubmit="return check_form(checkout);"') . tep_draw_hidden_field('action', 'process'). tep_draw_hidden_field('fromlogin', $fromlogin); ?><b><?php //echo TITLE_FORM; ?></b></td>
</tr>
<tr>
<td>
...
<tr><td class="main"><b><?php echo TITLE_SHIPPING_ADDRESS; ?></b></td></tr>
</table>
<!-- end of shipping address title -->
</TD></TR>
<TR><TD class="infoBox infoBoxContents" height="100%">
...
<tr>
<td class="infoBoxContents"><?php echo ENTRY_FIRST_NAME; ?></td>
<td class = "infoBoxContents"><input type="text" name="ShipFirstName" value="<? echo $shipping_firstname; ?>" size="20"><? echo '&nbsp;<span class="inputRequirement">' . ENTRY_CITY_TEXT . '</span>'; ?></td>
</tr> <tr>
<td class="infoBoxContents"><?php echo ENTRY_LAST_NAME; ?></td>
<td class = "infoBoxContents"><input name="ShipLastName" value="<? echo$shipping_lastname; ?>" size="20"><? echo '&nbsp;<span class="inputRequirement">' . ENTRY_CITY_TEXT . '</span>'; ?></td>
</tr>
<?php
...
if (ACCOUNT_SUBURB == 'true') {
	...
	<tr>
	<td class="infoBoxContents"><?php echo ENTRY_SUBURB; ?></td>
	<td class = "infoBoxContents"><tt><font size="2"><input name="shipsuburb" value="<? echo $shipping_suburb; ?>" size="20"></font></tt></td>
	</tr>
	<tr>
	<td class="infoBoxContents"><?php echo ENTRY_CITY; ?></td>
...
<tr>
<td class="infoBoxContents"><?php echo ENTRY_POST_CODE; ?></td>
<td class="infoBoxContents"><?php echo tep_draw_input_field('shippostcode') ; ?><? echo '&nbsp;<span class="inputRequirement">' . ENTRY_CITY_TEXT . '</span>'; ?></td>
</tr>
<tr>
<td class="infoBoxContents"><?php echo ENTRY_COUNTRY; ?></td>
