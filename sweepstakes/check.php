...
function check_date() {
  ...
  $r=mysql_query("select id,period,places from sweepstakes where date_ends='".mysql_escape_string($now_date)."' and enable='Y'",$link);
    //echo "select id,period,places from sweepstakes where date_ends='".mysql_escape_string($now_date)."' and enable='Y'";
//exit();
  ...
  if(mysql_numrows($r)==0)
    {
    echo 'All sweepstakes are already updated.';
   }
