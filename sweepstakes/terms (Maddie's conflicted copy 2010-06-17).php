    ...
    <table border="0" width="100%" cellspacing="0" cellpadding="7">
      <tr>
        <td><table border="0" width="100%" cellspacing="0" cellpadding="0">
          <tr>
            <td class="pageHeading" align="left"><?php echo $category['categories_name']; ?></td>
...
?>
    ...
    <table border="0" width="100%" cellspacing="0" cellpadding="7">
      <tr>
        <td><table border="0" width="100%" cellspacing="0" cellpadding="0">
          <tr>
            <td class="pageHeading" align="center" valign="top">
			<?php
			  $heading = '';
    if (isset($HTTP_GET_VARS['manufacturers_id'])) {
	...
	?>
<?php echo $heading; //tep_image(DIR_WS_IMAGES . $image, HEADING_TITLE, HEADING_IMAGE_WIDTH, HEADING_IMAGE_HEIGHT); ?></td>
...
?>
    ...
    <table border="0" width="100%" cellspacing="0" cellpadding="7">
      ...
      <tr>
        <td><table border="0" width="100%" cellspacing="0" cellpadding="0">
		  <tr>
            <td class="main" align="left"><?php require('header.php'); ?></td>
           </tr>
		  <TR>
		  <tr>
            <td class="main" align="left"><?php require('inc/terms.inc.php'); ?></td>
           </tr>
		  <TR>
                <TD ALIGN="CENTER">&nbsp;</TD>
              </TR>
		  ...
		  <tr>
            <td class="main" align="center"><?php require (DIR_WS_INCLUDES . 'front.php'); ?></td>
          </tr>
<?php
