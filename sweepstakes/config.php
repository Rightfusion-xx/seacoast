...
// Path to url - for example: "http://www.mydomain.com/script/" 
$script_url="http://www.seacoastvitamins.com/sweepstakes/";
...
$robot_email = "sweepstakes@seacoastvitamins.com";

// This name will be displayed in 'from' field of the mail messages
$robot_name = "Seacoast Vitamins Sweepstakes Admin";  

// Subject of message that will be sent to user to confirm registration
$confirm_email_subject = "Seacoast Vitamins Sweepstakes";  

// Subject of message that will be sent to Winner
$winner_email_subject = "Seacoast Vitamins Sweepstakes Winners";
...
$err[60] = "Please enter a valid email address";
