...
<div style="text-align:left;margin-top:20px;margin-bottom:20px;">
                 <div class="green box" style="float:left;">
                    ...
                    <div style="text-align:center;" margin-top: 30px;padding-left:20px;padding-right:80px;padding-bottom:10px;white-space:nowrap;background:#ffffff;">
                        ...
                        <img style="margin:3em;" width="120" height="93" src="/images/healthpricer_seal.gif" alt="SeacoastVitamins.com - Certified HealthPricer Merchant - Comparison Shopping Site for Health Products" border="0">
                        <br/>
