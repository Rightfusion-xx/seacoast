...
<title><?php echo $review['use'],' ',$review['products_name'] ?> </title>
      ...
      <tr>
        <td><table width="100%" border="0" cellspacing="0" cellpadding="2">
          <tr>
            <td valign="top"><table border="0" width="100%" cellspacing="0" cellpadding="2">
              <tr>
                <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
                  <tr>
                    <td class="main">
                    <a href="/product_info.php?products_id=<?php echo $review['products_id']; ?>"><?php echo $review['use'];?></a><br/>
                  ...
                  <tr class="infoBoxContents">
                    <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
                      <tr>
                        ...
                        <td class="main" align="right"><?php echo '<a href="' . tep_href_link(FILENAME_PRODUCT_REVIEWS_WRITE, 'products_id='.$review['products_id']) . '">' . tep_image_button('button_write_review.gif', IMAGE_BUTTON_WRITE_REVIEW) . '<br/>Write a Review!</a>'; ?></td>
                        <td width="10"><?php echo tep_draw_separator('pixel_trans.gif', '10', '1'); ?></td>
                      </tr>
                    </table></td>
                  </tr>
            ...
            <h3>Related Categories</h3><?php include(DIR_WS_MODULES . 'products_categories.php');?><?php related_product_categories($review['products_id']);?></td>
                         </td>
