...
?>
      <tr>
        <td><table border="0" width="100%" cellspacing="0" cellpadding="1" CLASS="infoBox"><TR><TD>
...
?>
          <tr CLASS="infoBoxContents">
            <td valign="top" class="main"><?php echo '<a href="' . tep_href_link(FILENAME_PRODUCT_INFO, 'products_id=' . $products_new['products_id']) . '"><b><u>' . $products_new['products_name'] . '</u></b></a><br>' . TEXT_DATE_ADDED . ' ' . tep_date_long($products_new['products_date_added']) . '<br><b>' . $products_new['products_head_desc_tag'] . '<br><br>' . TEXT_PRICE . ' ' . $products_price; ?></b></td>
            <td align="right" valign="top" class="main"><?php echo '<a href="' . tep_href_link(FILENAME_PRODUCTS_NEW, tep_get_all_get_params(array('action')) . 'action=buy_now&products_id=' . $products_new['products_id']) . '">' . tep_image_button('button_in_cart.gif', IMAGE_BUTTON_IN_CART) . '</a>'; ?></td>
          </tr>
          <tr CLASS="infoBoxContents">
...
?>
      <tr>
        <td><table border="0" width="100%" cellspacing="0" cellpadding="2" CLASS="infoBox"><TR><TD>
		<table border="0" width="100%" cellspacing="0" cellpadding="2">
          <tr>
            <td class="smallText"><?php echo $products_new_split->display_count(TEXT_DISPLAY_NUMBER_OF_PRODUCTS_NEW); ?></td>
            <td align="right" class="smallText"><?php echo TEXT_RESULT_PAGE . ' ' . $products_new_split->display_links(MAX_DISPLAY_PAGE_LINKS, tep_get_all_get_params(array('page', 'info', 'x', 'y'))); ?></td>
