...
<?PHP if (PRODUCT_LIST_CATALOG_MANUFACTURERS == 'show') { ?>
                <td class="tableData" align="center"><div align=left><?php echo '<a href="' . tep_href_link(FILENAME_PRODUCT_INFO, 'products_id=' . $products['products_id'], 'NONSSL') . '">' . $products['manufacturers_name'] . '</a>'; ?>&nbsp;</div></td>
<?PHP } ?>
...
<?PHP if (PRODUCT_LIST_CATALOG_DESCRIPTION == 'show') { ?>
               <td class="tableData" align="center"><?php echo substr(nl2br($products['products_description']), 0, $description_length); ?>...&nbsp;<?php echo '<a href="' . tep_href_link(FILENAME_PRODUCT_INFO, $products['products_id'], 'NONSSL') . '"><i>More Info</i>...</a>'; ?></td>
<?PHP } ?>
